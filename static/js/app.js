...
function filterTable() {
  ...
  // 9. Loop through all the filters and keep any data that matches the filter values

  // Destructuring for...in is deprecated. Use for...of instead.
  // SOURCE: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Deprecated_and_obsolete_features#statements
